...
public abstract class DebateMigrationCategoryLocalServiceBaseImpl
    implements DebateMigrationCategoryLocalService {
    ...
    public DebateMigrationCategory addDebateMigrationCategory(
        ...
        return debateMigrationCategoryPersistence.update(debateMigrationCategory,
            false);
    }

    public DebateMigrationCategory createDebateMigrationCategory(
    ...
    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return debateMigrationCategoryPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public DebateMigrationCategory getDebateMigrationCategory(
        Long debateMigrationCategoryPK) throws PortalException, SystemException {
        return debateMigrationCategoryPersistence.findByPrimaryKey(debateMigrationCategoryPK);
    }

    public List<DebateMigrationCategory> getDebateMigrationCategories(
