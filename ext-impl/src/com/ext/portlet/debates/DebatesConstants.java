...
public class DebatesConstants {
     ...
     */
    public static final String VIEW_DEBATES_INDEX_TABS = "viewDebatesIndexTab";
     ...
     */
    public static final String VIEW_DISCUSSION_FORWARD = "portlet.ext.debates.view_discussion";

    /**
     * Forward name for main view.
     */
    public static final String VIEW_ACTION_FORWARD = "portlet.ext.debates.view";

    /**
     * Forward name for editing issue.
     */
    public static final String EDIT_ISSUE_FORWARD = "portlet.ext.debates.edit_issue";

    /**
     * Forward name for moving a message.
     */
    public static final String MOVE_MESSAGE_FORWARD = "portlet.ext.debates.move_message";

    /**
     * Forward name for viewing a debate.
     */
    public static final String VIEW_DEBATE_FORWARD = "portlet.ext.debates.view_debate";
     ...
     */
    public static final String CONFIGURATION_JSP = "/html/portlet/ext/debates/configuration.jsp";
     ...
     */
    public static final String DEFAULT_DEBATES_CATEGORY_NAME = "Debates Portlet";
    ...
    public static final String CATEGORY_REPLACEMENT_STRING  = "DEBATE_CATEGORY_ID";
    
    public static final String MESSAGE_REPLACEMENT_STRING  = "MESSAGE_ID";
    
    
    public static final String MESSAGE_URL= "/web/guest/debates?p_p_id=debates&amp;p_p_lifecycle=0&amp;p_p_state=normal&amp;p_p_mode=view&amp;p_p_col_id=column-1&amp;p_p_col_count=2&amp;_debates_struts_action=%2Fext%2Fdebates%2Fview_debate&amp;_debates_categoryId=DEBATE_CATEGORY_ID#_debates_message_MESSAGE_ID";
    
    public static final String CATEGORY_URL="/web/guest/debates?p_p_id=debates&amp;p_p_lifecycle=0&amp;p_p_state=normal&amp;p_p_mode=view&amp;p_p_col_id=column-1&amp;p_p_col_count=2&amp;_debates_struts_action=%2Fext%2Fdebates%2Fview_debate&amp;_debates_categoryId=DEBATE_CATEGORY_ID";

    
    /** Portlet permissions **/
    
    public static final String ADD_DEBATE_QUESTION = "ADD_DEBATE_QUESTION";
    public static final String ADD_DEBATE_POSITION = "ADD_DEBATE_POSITION";
    public static final String ADD_DEBATE_ARGUMENT = "ADD_DEBATE_ARGUMENT ";
    public static final String DELETE_DEBATE_QUESTION = "DELETE_DEBATE_QUESTION";
    public static final String DELETE_DEBATE_POSITION = "DELETE_DEBATE_POSITION";
    public static final String DELETE_DEBATE_ARGUMENT = "DELETE_DEBATE_ARGUMENT";
    public static final String COMMENT_ON_DEBATE = "COMMENT_ON_DEBATE";
 
    public static final String MOVE_DEBATE_TREE = "MOVE_DEBATE_TREE";
    public static final String SUBSCRIBE = "SUBSCRIBE";
    public static final String UPDATE_DEBATE_QUESTION = "UPDATE_DEBATE_QUESTION";
    public static final String UPDATE_DEBATE_POSITION = "UPDATE_DEBATE_POSITION";
    public static final String UPDATE_DEBATE_ARGUMENT = "UPDATE_DEBATE_ARGUMENT";
    public static final String VIEW = "VIEW ";

	public static final String DEBATE_MESSAGE_ID = "debate message id";
