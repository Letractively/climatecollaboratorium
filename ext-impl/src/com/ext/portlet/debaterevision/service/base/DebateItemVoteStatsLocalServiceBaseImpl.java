...
public abstract class DebateItemVoteStatsLocalServiceBaseImpl
    implements DebateItemVoteStatsLocalService {
    ...
    public DebateItemVoteStats addDebateItemVoteStats(
        DebateItemVoteStats debateItemVoteStats) throws SystemException {
        debateItemVoteStats.setNew(true);

        return debateItemVoteStatsPersistence.update(debateItemVoteStats, false);
    }

    public DebateItemVoteStats createDebateItemVoteStats(
        Long debateItemVotesStats) {
        return debateItemVoteStatsPersistence.create(debateItemVotesStats);
    }

    public void deleteDebateItemVoteStats(Long debateItemVotesStats)
        throws PortalException, SystemException {
        debateItemVoteStatsPersistence.remove(debateItemVotesStats);
    }

    public void deleteDebateItemVoteStats(
        DebateItemVoteStats debateItemVoteStats) throws SystemException {
        debateItemVoteStatsPersistence.remove(debateItemVoteStats);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return debateItemVoteStatsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public DebateItemVoteStats getDebateItemVoteStats(Long debateItemVotesStats)
        throws PortalException, SystemException {
        return debateItemVoteStatsPersistence.findByPrimaryKey(debateItemVotesStats);
    }

    public List<DebateItemVoteStats> getDebateItemVoteStatses(int start, int end)
        throws SystemException {
        return debateItemVoteStatsPersistence.findAll(start, end);
    }

    public int getDebateItemVoteStatsesCount() throws SystemException {
        return debateItemVoteStatsPersistence.countAll();
    }

    public DebateItemVoteStats updateDebateItemVoteStats(
        DebateItemVoteStats debateItemVoteStats) throws SystemException {
        debateItemVoteStats.setNew(false);

        return debateItemVoteStatsPersistence.update(debateItemVoteStats, true);
    }

    public DebateItemVoteStats updateDebateItemVoteStats(
        DebateItemVoteStats debateItemVoteStats, boolean merge)
        throws SystemException {
        debateItemVoteStats.setNew(false);

        return debateItemVoteStatsPersistence.update(debateItemVoteStats, merge);
    }
