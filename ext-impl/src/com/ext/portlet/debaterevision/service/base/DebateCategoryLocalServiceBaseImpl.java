...
public abstract class DebateCategoryLocalServiceBaseImpl
    implements DebateCategoryLocalService {
    ...
    public DebateCategory addDebateCategory(DebateCategory debateCategory)
        throws SystemException {
        debateCategory.setNew(true);

        return debateCategoryPersistence.update(debateCategory, false);
    }

    public DebateCategory createDebateCategory(Long debateCategoryPK) {
        return debateCategoryPersistence.create(debateCategoryPK);
    }

    public void deleteDebateCategory(Long debateCategoryPK)
        throws PortalException, SystemException {
        debateCategoryPersistence.remove(debateCategoryPK);
    }

    public void deleteDebateCategory(DebateCategory debateCategory)
        throws SystemException {
        debateCategoryPersistence.remove(debateCategory);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return debateCategoryPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public DebateCategory getDebateCategory(Long debateCategoryPK)
        throws PortalException, SystemException {
        return debateCategoryPersistence.findByPrimaryKey(debateCategoryPK);
    }

    public List<DebateCategory> getDebateCategories(int start, int end)
        throws SystemException {
        return debateCategoryPersistence.findAll(start, end);
    }

    public int getDebateCategoriesCount() throws SystemException {
        return debateCategoryPersistence.countAll();
    }

    public DebateCategory updateDebateCategory(DebateCategory debateCategory)
        throws SystemException {
        debateCategory.setNew(false);

        return debateCategoryPersistence.update(debateCategory, true);
    }
    ...
    public DebateCategory updateDebateCategory(DebateCategory debateCategory,
        ...
        return debateCategoryPersistence.update(debateCategory, merge);
    }
