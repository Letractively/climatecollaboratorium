 ...
 *
 */
public class ViewModelDebatesAction extends ViewAction {
    ...
    public ActionForward render(ActionMapping mapping, ActionForm form, PortletConfig portletConfig, RenderRequest renderRequest,
        ...
        if (mainTab.equals(DebatesConstants.DISCUSSION_TAB)) {
            ...
            renderRequest.setAttribute(DebatesConstants.VIEW_DEBATES_INDEX_TABS,
       ...
       ActionForward result =  mapping.findForward(DebatesConstants.VIEW_ACTION_FORWARD);
       return result;
    }
