...
public abstract class MessagingIgnoredRecipientsLocalServiceBaseImpl
    ...
    public MessagingIgnoredRecipients addMessagingIgnoredRecipients(
        MessagingIgnoredRecipients messagingIgnoredRecipients)
        throws SystemException {
        messagingIgnoredRecipients.setNew(true);

        return messagingIgnoredRecipientsPersistence.update(messagingIgnoredRecipients,
            false);
    }

    public MessagingIgnoredRecipients createMessagingIgnoredRecipients(
        Long ignoredRecipientId) {
        return messagingIgnoredRecipientsPersistence.create(ignoredRecipientId);
    }

    public void deleteMessagingIgnoredRecipients(Long ignoredRecipientId)
        throws PortalException, SystemException {
        messagingIgnoredRecipientsPersistence.remove(ignoredRecipientId);
    }

    public void deleteMessagingIgnoredRecipients(
        MessagingIgnoredRecipients messagingIgnoredRecipients)
        throws SystemException {
        messagingIgnoredRecipientsPersistence.remove(messagingIgnoredRecipients);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return messagingIgnoredRecipientsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public MessagingIgnoredRecipients getMessagingIgnoredRecipients(
        Long ignoredRecipientId) throws PortalException, SystemException {
        return messagingIgnoredRecipientsPersistence.findByPrimaryKey(ignoredRecipientId);
    }

    public List<MessagingIgnoredRecipients> getMessagingIgnoredRecipientses(
        int start, int end) throws SystemException {
        return messagingIgnoredRecipientsPersistence.findAll(start, end);
    }

    public int getMessagingIgnoredRecipientsesCount() throws SystemException {
        return messagingIgnoredRecipientsPersistence.countAll();
    }

    public MessagingIgnoredRecipients updateMessagingIgnoredRecipients(
        MessagingIgnoredRecipients messagingIgnoredRecipients)
        throws SystemException {
