...
public abstract class MessagingMessageRecipientLocalServiceBaseImpl
    ...
    public MessagingMessageRecipient addMessagingMessageRecipient(
        MessagingMessageRecipient messagingMessageRecipient)
        throws SystemException {
        messagingMessageRecipient.setNew(true);

        return messagingMessageRecipientPersistence.update(messagingMessageRecipient,
            false);
    }

    public MessagingMessageRecipient createMessagingMessageRecipient(
        Long recipientId) {
        return messagingMessageRecipientPersistence.create(recipientId);
    }

    public void deleteMessagingMessageRecipient(Long recipientId)
        throws PortalException, SystemException {
        messagingMessageRecipientPersistence.remove(recipientId);
    }

    public void deleteMessagingMessageRecipient(
        MessagingMessageRecipient messagingMessageRecipient)
        throws SystemException {
        messagingMessageRecipientPersistence.remove(messagingMessageRecipient);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return messagingMessageRecipientPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public MessagingMessageRecipient getMessagingMessageRecipient(
        Long recipientId) throws PortalException, SystemException {
        return messagingMessageRecipientPersistence.findByPrimaryKey(recipientId);
    }

    public List<MessagingMessageRecipient> getMessagingMessageRecipients(
        int start, int end) throws SystemException {
        return messagingMessageRecipientPersistence.findAll(start, end);
    }

    public int getMessagingMessageRecipientsCount() throws SystemException {
        return messagingMessageRecipientPersistence.countAll();
    }

    public MessagingMessageRecipient updateMessagingMessageRecipient(
        MessagingMessageRecipient messagingMessageRecipient)
        throws SystemException {
