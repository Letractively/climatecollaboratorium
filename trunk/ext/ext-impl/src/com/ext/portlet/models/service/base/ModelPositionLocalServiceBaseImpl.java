...
public abstract class ModelPositionLocalServiceBaseImpl
    ...
    public ModelPosition addModelPosition(ModelPosition modelPosition)
    ...
    public void deleteModelPosition(ModelPosition modelPosition)
        throws SystemException {
        modelPositionPersistence.remove(modelPosition);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return modelPositionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<ModelPosition> getModelPositions(int start, int end)
        throws SystemException {
        return modelPositionPersistence.findAll(start, end);
    }

    public int getModelPositionsCount() throws SystemException {
        return modelPositionPersistence.countAll();
    }
    ...
    public ModelPosition updateModelPosition(ModelPosition modelPosition)
        ...
        return modelPositionPersistence.update(modelPosition, true);
    }
    ...
    public ModelPosition updateModelPosition(ModelPosition modelPosition,
        ...
        return modelPositionPersistence.update(modelPosition, merge);
    }
