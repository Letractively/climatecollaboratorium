...
public abstract class PlanPositionsLocalServiceBaseImpl
    ...
    public PlanPositions addPlanPositions(PlanPositions planPositions)
        throws SystemException {
        planPositions.setNew(true);

        return planPositionsPersistence.update(planPositions, false);
    }
    ...
    public void deletePlanPositions(Long id)
        ...
        planPositionsPersistence.remove(id);
    }

    public void deletePlanPositions(PlanPositions planPositions)
        throws SystemException {
        planPositionsPersistence.remove(planPositions);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planPositionsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanPositions> getPlanPositionses(int start, int end)
        throws SystemException {
        return planPositionsPersistence.findAll(start, end);
    }

    public int getPlanPositionsesCount() throws SystemException {
        return planPositionsPersistence.countAll();
    }

    public PlanPositions updatePlanPositions(PlanPositions planPositions)
        throws SystemException {
        planPositions.setNew(false);

        return planPositionsPersistence.update(planPositions, true);
    }
    ...
    public PlanPositions updatePlanPositions(PlanPositions planPositions,
        ...
        return planPositionsPersistence.update(planPositions, merge);
    }
