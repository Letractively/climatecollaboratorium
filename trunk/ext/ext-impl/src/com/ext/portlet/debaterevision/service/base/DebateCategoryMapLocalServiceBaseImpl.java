...
public abstract class DebateCategoryMapLocalServiceBaseImpl
    implements DebateCategoryMapLocalService {
    ...
    public DebateCategoryMap addDebateCategoryMap(
        DebateCategoryMap debateCategoryMap) throws SystemException {
        debateCategoryMap.setNew(true);

        return debateCategoryMapPersistence.update(debateCategoryMap, false);
    }

    public DebateCategoryMap createDebateCategoryMap(Long debateCategoryMapPK) {
        return debateCategoryMapPersistence.create(debateCategoryMapPK);
    }

    public void deleteDebateCategoryMap(Long debateCategoryMapPK)
        throws PortalException, SystemException {
        debateCategoryMapPersistence.remove(debateCategoryMapPK);
    }

    public void deleteDebateCategoryMap(DebateCategoryMap debateCategoryMap)
        throws SystemException {
        debateCategoryMapPersistence.remove(debateCategoryMap);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return debateCategoryMapPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public DebateCategoryMap getDebateCategoryMap(Long debateCategoryMapPK)
        throws PortalException, SystemException {
        return debateCategoryMapPersistence.findByPrimaryKey(debateCategoryMapPK);
    }

    public List<DebateCategoryMap> getDebateCategoryMaps(int start, int end)
        throws SystemException {
        return debateCategoryMapPersistence.findAll(start, end);
    }

    public int getDebateCategoryMapsCount() throws SystemException {
        return debateCategoryMapPersistence.countAll();
    }

    public DebateCategoryMap updateDebateCategoryMap(
        DebateCategoryMap debateCategoryMap) throws SystemException {
        debateCategoryMap.setNew(false);

        return debateCategoryMapPersistence.update(debateCategoryMap, true);
    }

    public DebateCategoryMap updateDebateCategoryMap(
        DebateCategoryMap debateCategoryMap, boolean merge)
        throws SystemException {
        debateCategoryMap.setNew(false);

        return debateCategoryMapPersistence.update(debateCategoryMap, merge);
    }
