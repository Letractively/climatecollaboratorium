...
import com.ext.portlet.discussions.service.impl.DiscussionMessageLocalServiceImpl;
...
public enum SearchItemType {
    ...
    PLAN(new String[] { "entryClassName", "com.ext.portlet.plans.model.*" }, new String[] { "content", "title" },
    ...
    USER(new String[] { "active", "true" }, new String[] { "screenName", "firstName", "lastName" },
            ...
            }), WIKI(new String[] { "entryClassName", "com.liferay.portlet.wiki.model.*" }, new String[] { "title",
    ...
    BLOG(new String[] { "entryClassName", "com.liferay.portlet.blogs.model.*" }, new String[] { "title", "content" },
            new String[] { "title" }, new String[] { "content" }, new URLCreator() {
    ...
    DISCUSSION(new String[] { "entryClassName", "com.ext.portlet.discussions.model.*" }, new String[] { "title",
            "content" }, new String[] { "title" }, new String[] { "content" }, new URLCreator() {
    ...
    SearchItemType(String[] determinatorInfo, String[] searchFields, String[] titleFields, String[] contentFields,
