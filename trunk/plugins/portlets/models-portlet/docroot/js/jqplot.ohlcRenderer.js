...
(function($) {
     ...
     * 
     * > series: [{renderer:jQuery.jqplot.OHLCRenderer}]
     * 
     ...
     * 
     * > series: [{renderer:jQuery.jqplot.OHLCRenderer, rendererOptions:{candleStick:true}}],
     * 
     */
    jQuery.jqplot.OHLCRenderer = function(){
        // subclass line renderer to make use of some of it's methods.
        jQuery.jqplot.LineRenderer.call(this);
        // prop: candleStick
    ...
    jQuery.jqplot.OHLCRenderer.prototype = new jQuery.jqplot.LineRenderer();
    jQuery.jqplot.OHLCRenderer.prototype.constructor = jQuery.jqplot.OHLCRenderer;
    
    // called with scope of series.
    jQuery.jqplot.OHLCRenderer.prototype.init = function(options) {
        // prop: lineWidth
        // Width of the hi-low line and open/close ticks.
        this.lineWidth = 1.5;
        jQuery.jqplot.LineRenderer.prototype.init.call(this, options);
    ...
    jQuery.jqplot.OHLCRenderer.prototype.draw = function(ctx, gd, options) {
        var d = this.data;
    ...
    jQuery.jqplot.OHLCRenderer.prototype.drawShadow = function(ctx, gd, options) {
        // This is a no-op, shadows drawn with lines.
    };
    
    // called with scope of plot.
    jQuery.jqplot.OHLCRenderer.checkOptions = function(target, data, options) {
	...
	//jQuery.jqplot.preInitHooks.push(jQuery.jqplot.OHLCRenderer.checkOptions);
