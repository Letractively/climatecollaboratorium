...
public enum DebateActivityKeys implements SubscriberFactory {
	...
	ADD_QUESTION_TO_CATEGORY("Question added"), EDIT_QUESTION("Question edited"), REMOVE_QUESTION("Question removed"),
	...
	COMMENT_ON_POSITION("Commented on position"), COMMENT_ON_ARGUMENT("Commented on argument"), 
	COMMENT_ON_QUESTION("Comment on question"), REMOVE_QUESTION_FROM_CATEGORY("Question removed from category");
