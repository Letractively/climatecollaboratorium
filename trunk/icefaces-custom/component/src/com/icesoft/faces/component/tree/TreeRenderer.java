...
public class TreeRenderer extends DomBasicRenderer {
    ...
    public void encodeParentAndChildNodes(FacesContext facesContext,
        ...
        Element treeNodeTable = domContext.createElement(HTML.TABLE_ELEM);
        Element treeNodeTr = domContext.createElement(HTML.TR_ELEM);
        Element treeNodeTd1 = domContext.createElement(HTML.TD_ELEM);
        Element treeNodeTd2 = domContext.createElement(HTML.TD_ELEM);
        
        treeNodeTr.appendChild(treeNodeTd1);
        treeNodeTr.appendChild(treeNodeTd2);
        treeNodeTable.appendChild(treeNodeTr);
        treeNodeDiv.appendChild(treeNodeTable);
        
        treeNodeTd1.setAttribute(HTML.CLASS_ATTR, "treeNodeNavigation");
        treeNodeTd2.setAttribute(HTML.CLASS_ATTR, "treeNodeContents");
        ...
        if (!hideCurrentNode) {
            ...
            domContext.setCursorParent(treeNodeTd2);
            encodeNode(facesContext, treeComponent, current, treeNodeDiv,
                       treeNodeTd1, treeNodeTd2,
    ...
    public void encodeNode(FacesContext facesContext,
        ...
        boolean hasSiblings = currentNode.getNextSibling() != null;
        ...
        */
        if (level > 0) {
            treeNodeDiv.setAttribute("class", treeNodeDiv.getAttribute("class") + " iceTreeNodeChild");
            if (!hasSiblings) {
                treeNodeDiv.setAttribute("class", treeNodeDiv.getAttribute("class") + " iceTreeNodeLastChild");
            }
        }
        ...
        if (isBranchNode && !hideNavigation) {
            ...
            /** append navigation to td1 */
            treeNodeTd1.appendChild(navAnchor);
