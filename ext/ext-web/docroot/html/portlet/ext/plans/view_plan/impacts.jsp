...
<script type="text/javascript">
    ...
    */ 
    ...
    Liferay.Widget({ url: "/widget/web/guest/models/-/models_WAR_modelsportlet_INSTANCE_c0EK?modelId=<%= plan.getPlanType().getModelId() %><%= plan.getScenarioId() != null ? "&scenarioId=" + plan.getScenarioId() : "" %>&viewType=embedded&page=impacts&scenarioId=<%= plan.getScenarioId() %>" ,  id: "portlet-model-impacts", scrolling: "no", FRAMEBORDER: 0});
