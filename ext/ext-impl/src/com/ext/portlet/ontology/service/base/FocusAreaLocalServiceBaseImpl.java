...
public abstract class FocusAreaLocalServiceBaseImpl
    implements FocusAreaLocalService {
    ...
    public FocusArea addFocusArea(FocusArea focusArea)
        throws SystemException {
        focusArea.setNew(true);

        return focusAreaPersistence.update(focusArea, false);
    }
    ...
    public void deleteFocusArea(Long id)
        ...
        focusAreaPersistence.remove(id);
    }

    public void deleteFocusArea(FocusArea focusArea) throws SystemException {
        focusAreaPersistence.remove(focusArea);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return focusAreaPersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return focusAreaPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public List<FocusArea> getFocusAreas(int start, int end)
        throws SystemException {
        return focusAreaPersistence.findAll(start, end);
    }

    public int getFocusAreasCount() throws SystemException {
        return focusAreaPersistence.countAll();
    }
    ...
    public FocusArea updateFocusArea(FocusArea focusArea)
        ...
        return focusAreaPersistence.update(focusArea, true);
    }

    public FocusArea updateFocusArea(FocusArea focusArea, boolean merge)
        throws SystemException {
        focusArea.setNew(false);

        return focusAreaPersistence.update(focusArea, merge);
    }
