...
public abstract class PlanTeamHistoryLocalServiceBaseImpl
    ...
    public PlanTeamHistory addPlanTeamHistory(PlanTeamHistory planTeamHistory)
        throws SystemException {
        planTeamHistory.setNew(true);

        return planTeamHistoryPersistence.update(planTeamHistory, false);
    }
    ...
    public void deletePlanTeamHistory(Long id)
        ...
        planTeamHistoryPersistence.remove(id);
    }

    public void deletePlanTeamHistory(PlanTeamHistory planTeamHistory)
        throws SystemException {
        planTeamHistoryPersistence.remove(planTeamHistory);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planTeamHistoryPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanTeamHistory> getPlanTeamHistories(int start, int end)
        throws SystemException {
        return planTeamHistoryPersistence.findAll(start, end);
    }

    public int getPlanTeamHistoriesCount() throws SystemException {
        return planTeamHistoryPersistence.countAll();
    }

    public PlanTeamHistory updatePlanTeamHistory(
        PlanTeamHistory planTeamHistory) throws SystemException {
        planTeamHistory.setNew(false);

        return planTeamHistoryPersistence.update(planTeamHistory, true);
    }

    public PlanTeamHistory updatePlanTeamHistory(
        PlanTeamHistory planTeamHistory, boolean merge)
        throws SystemException {
        planTeamHistory.setNew(false);

        return planTeamHistoryPersistence.update(planTeamHistory, merge);
    }
