...
public abstract class PlanModelRunLocalServiceBaseImpl
    implements PlanModelRunLocalService {
    ...
    public PlanModelRun addPlanModelRun(PlanModelRun planModelRun)
        throws SystemException {
        planModelRun.setNew(true);

        return planModelRunPersistence.update(planModelRun, false);
    }
    ...
    public void deletePlanModelRun(Long id)
        ...
        planModelRunPersistence.remove(id);
    }

    public void deletePlanModelRun(PlanModelRun planModelRun)
        throws SystemException {
        planModelRunPersistence.remove(planModelRun);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planModelRunPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanModelRun> getPlanModelRuns(int start, int end)
        throws SystemException {
        return planModelRunPersistence.findAll(start, end);
    }

    public int getPlanModelRunsCount() throws SystemException {
        return planModelRunPersistence.countAll();
    }

    public PlanModelRun updatePlanModelRun(PlanModelRun planModelRun)
        throws SystemException {
        planModelRun.setNew(false);

        return planModelRunPersistence.update(planModelRun, true);
    }
    ...
    public PlanModelRun updatePlanModelRun(PlanModelRun planModelRun,
        ...
        return planModelRunPersistence.update(planModelRun, merge);
    }
