...
public abstract class PlanPropertyFilterLocalServiceBaseImpl
    ...
    public PlanPropertyFilter addPlanPropertyFilter(
        PlanPropertyFilter planPropertyFilter) throws SystemException {
        planPropertyFilter.setNew(true);

        return planPropertyFilterPersistence.update(planPropertyFilter, false);
    }
    ...
    public void deletePlanPropertyFilter(Long planPropertyFilterId)
        ...
        planPropertyFilterPersistence.remove(planPropertyFilterId);
    }

    public void deletePlanPropertyFilter(PlanPropertyFilter planPropertyFilter)
        throws SystemException {
        planPropertyFilterPersistence.remove(planPropertyFilter);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planPropertyFilterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanPropertyFilter> getPlanPropertyFilters(int start, int end)
        throws SystemException {
        return planPropertyFilterPersistence.findAll(start, end);
    }

    public int getPlanPropertyFiltersCount() throws SystemException {
        return planPropertyFilterPersistence.countAll();
    }

    public PlanPropertyFilter updatePlanPropertyFilter(
        PlanPropertyFilter planPropertyFilter) throws SystemException {
        planPropertyFilter.setNew(false);

        return planPropertyFilterPersistence.update(planPropertyFilter, true);
    }
    ...
    public PlanPropertyFilter updatePlanPropertyFilter(
        ...
        return planPropertyFilterPersistence.update(planPropertyFilter, merge);
    }
