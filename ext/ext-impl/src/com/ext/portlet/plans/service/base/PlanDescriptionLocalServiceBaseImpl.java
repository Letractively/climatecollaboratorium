...
public abstract class PlanDescriptionLocalServiceBaseImpl
    ...
    public PlanDescription addPlanDescription(PlanDescription planDescription)
        throws SystemException {
        planDescription.setNew(true);

        return planDescriptionPersistence.update(planDescription, false);
    }
    ...
    public void deletePlanDescription(Long id)
        ...
        planDescriptionPersistence.remove(id);
    }

    public void deletePlanDescription(PlanDescription planDescription)
        throws SystemException {
        planDescriptionPersistence.remove(planDescription);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planDescriptionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanDescription> getPlanDescriptions(int start, int end)
        throws SystemException {
        return planDescriptionPersistence.findAll(start, end);
    }

    public int getPlanDescriptionsCount() throws SystemException {
        return planDescriptionPersistence.countAll();
    }

    public PlanDescription updatePlanDescription(
        PlanDescription planDescription) throws SystemException {
        planDescription.setNew(false);

        return planDescriptionPersistence.update(planDescription, true);
    }

    public PlanDescription updatePlanDescription(
        PlanDescription planDescription, boolean merge)
        throws SystemException {
        planDescription.setNew(false);

        return planDescriptionPersistence.update(planDescription, merge);
    }
