...
public abstract class PlanTemplateSectionLocalServiceBaseImpl
    ...
    public PlanTemplateSection addPlanTemplateSection(
        PlanTemplateSection planTemplateSection) throws SystemException {
        planTemplateSection.setNew(true);

        return planTemplateSectionPersistence.update(planTemplateSection, false);
    }

    public PlanTemplateSection createPlanTemplateSection(
        PlanTemplateSectionPK planTemplateSectionPK) {
        return planTemplateSectionPersistence.create(planTemplateSectionPK);
    }

    public void deletePlanTemplateSection(
        PlanTemplateSectionPK planTemplateSectionPK)
        throws PortalException, SystemException {
        planTemplateSectionPersistence.remove(planTemplateSectionPK);
    }

    public void deletePlanTemplateSection(
        PlanTemplateSection planTemplateSection) throws SystemException {
        planTemplateSectionPersistence.remove(planTemplateSection);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planTemplateSectionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PlanTemplateSection getPlanTemplateSection(
        PlanTemplateSectionPK planTemplateSectionPK)
        throws PortalException, SystemException {
        return planTemplateSectionPersistence.findByPrimaryKey(planTemplateSectionPK);
    }

    public List<PlanTemplateSection> getPlanTemplateSections(int start, int end)
        throws SystemException {
        return planTemplateSectionPersistence.findAll(start, end);
    }

    public int getPlanTemplateSectionsCount() throws SystemException {
        return planTemplateSectionPersistence.countAll();
    }

    public PlanTemplateSection updatePlanTemplateSection(
        PlanTemplateSection planTemplateSection) throws SystemException {
        planTemplateSection.setNew(false);

        return planTemplateSectionPersistence.update(planTemplateSection, true);
    }

    public PlanTemplateSection updatePlanTemplateSection(
        PlanTemplateSection planTemplateSection, boolean merge)
        throws SystemException {
        planTemplateSection.setNew(false);

        return planTemplateSectionPersistence.update(planTemplateSection, merge);
    }
