...
public abstract class PlanItemLocalServiceBaseImpl
    implements PlanItemLocalService {
    ...
    public PlanItem addPlanItem(PlanItem planItem) throws SystemException {
        planItem.setNew(true);

        return planItemPersistence.update(planItem, false);
    }
    ...
    public void deletePlanItem(Long id) throws PortalException, SystemException {
        planItemPersistence.remove(id);
    }

    public void deletePlanItem(PlanItem planItem) throws SystemException {
        planItemPersistence.remove(planItem);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planItemPersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return planItemPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List<PlanItem> getPlanItems(int start, int end)
        throws SystemException {
        return planItemPersistence.findAll(start, end);
    }

    public int getPlanItemsCount() throws SystemException {
        return planItemPersistence.countAll();
    }

    public PlanItem updatePlanItem(PlanItem planItem) throws SystemException {
        planItem.setNew(false);

        return planItemPersistence.update(planItem, true);
    }

    public PlanItem updatePlanItem(PlanItem planItem, boolean merge)
        throws SystemException {
        planItem.setNew(false);

        return planItemPersistence.update(planItem, merge);
    }
