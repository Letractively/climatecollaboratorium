...
public abstract class PlanFanLocalServiceBaseImpl implements PlanFanLocalService {
    ...
    public PlanFan addPlanFan(PlanFan planFan) throws SystemException {
        ...
        return planFanPersistence.update(planFan, false);
    }
    ...
    public void deletePlanFan(Long id) throws PortalException, SystemException {
        planFanPersistence.remove(id);
    }

    public void deletePlanFan(PlanFan planFan) throws SystemException {
        planFanPersistence.remove(planFan);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planFanPersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return planFanPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List<PlanFan> getPlanFans(int start, int end)
        throws SystemException {
        return planFanPersistence.findAll(start, end);
    }

    public int getPlanFansCount() throws SystemException {
        return planFanPersistence.countAll();
    }

    public PlanFan updatePlanFan(PlanFan planFan) throws SystemException {
        planFan.setNew(false);

        return planFanPersistence.update(planFan, true);
    }

    public PlanFan updatePlanFan(PlanFan planFan, boolean merge)
        throws SystemException {
        planFan.setNew(false);

        return planFanPersistence.update(planFan, merge);
    }
