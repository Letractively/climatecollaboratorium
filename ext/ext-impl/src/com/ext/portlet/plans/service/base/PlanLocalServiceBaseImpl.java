...
public abstract class PlanLocalServiceBaseImpl implements PlanLocalService {
    ...
    public Plan addPlan(Plan plan) throws SystemException {
        plan.setNew(true);

        return planPersistence.update(plan, false);
    }
    ...
    public void deletePlan(Long planId) throws PortalException, SystemException {
        planPersistence.remove(planId);
    }

    public void deletePlan(Plan plan) throws SystemException {
        planPersistence.remove(plan);
    }
    ...
    public Plan getPlan(Long planId) throws PortalException, SystemException {
        return planPersistence.findByPrimaryKey(planId);
    }

    public List<Plan> getPlans(int start, int end) throws SystemException {
        return planPersistence.findAll(start, end);
    }

    public int getPlansCount() throws SystemException {
        return planPersistence.countAll();
    }

    public Plan updatePlan(Plan plan) throws SystemException {
        plan.setNew(false);

        return planPersistence.update(plan, true);
    }

    public Plan updatePlan(Plan plan, boolean merge) throws SystemException {
        plan.setNew(false);

        return planPersistence.update(plan, merge);
    }
