...
public abstract class PlanSectionDefinitionLocalServiceBaseImpl
    ...
    public PlanSectionDefinition addPlanSectionDefinition(
        PlanSectionDefinition planSectionDefinition) throws SystemException {
        planSectionDefinition.setNew(true);

        return planSectionDefinitionPersistence.update(planSectionDefinition,
            false);
    }

    public PlanSectionDefinition createPlanSectionDefinition(Long id) {
        return planSectionDefinitionPersistence.create(id);
    }

    public void deletePlanSectionDefinition(Long id)
        throws PortalException, SystemException {
        planSectionDefinitionPersistence.remove(id);
    }

    public void deletePlanSectionDefinition(
        PlanSectionDefinition planSectionDefinition) throws SystemException {
        planSectionDefinitionPersistence.remove(planSectionDefinition);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planSectionDefinitionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PlanSectionDefinition getPlanSectionDefinition(Long id)
        throws PortalException, SystemException {
        return planSectionDefinitionPersistence.findByPrimaryKey(id);
    }

    public List<PlanSectionDefinition> getPlanSectionDefinitions(int start,
        int end) throws SystemException {
        return planSectionDefinitionPersistence.findAll(start, end);
    }

    public int getPlanSectionDefinitionsCount() throws SystemException {
        return planSectionDefinitionPersistence.countAll();
    }

    public PlanSectionDefinition updatePlanSectionDefinition(
        PlanSectionDefinition planSectionDefinition) throws SystemException {
