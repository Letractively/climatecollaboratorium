...
public abstract class PlanColumnSettingsLocalServiceBaseImpl
    ...
    public PlanColumnSettings addPlanColumnSettings(
        PlanColumnSettings planColumnSettings) throws SystemException {
        planColumnSettings.setNew(true);

        return planColumnSettingsPersistence.update(planColumnSettings, false);
    }
    ...
    public void deletePlanColumnSettings(Long planColumnSettingsId)
        ...
        planColumnSettingsPersistence.remove(planColumnSettingsId);
    }

    public void deletePlanColumnSettings(PlanColumnSettings planColumnSettings)
        throws SystemException {
        planColumnSettingsPersistence.remove(planColumnSettings);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planColumnSettingsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanColumnSettings> getPlanColumnSettingses(int start, int end)
        throws SystemException {
        return planColumnSettingsPersistence.findAll(start, end);
    }

    public int getPlanColumnSettingsesCount() throws SystemException {
        return planColumnSettingsPersistence.countAll();
    }

    public PlanColumnSettings updatePlanColumnSettings(
        PlanColumnSettings planColumnSettings) throws SystemException {
        planColumnSettings.setNew(false);

        return planColumnSettingsPersistence.update(planColumnSettings, true);
    }
    ...
    public PlanColumnSettings updatePlanColumnSettings(
        ...
        return planColumnSettingsPersistence.update(planColumnSettings, merge);
    }
