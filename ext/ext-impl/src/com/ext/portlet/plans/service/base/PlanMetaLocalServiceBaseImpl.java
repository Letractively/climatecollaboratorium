...
public abstract class PlanMetaLocalServiceBaseImpl
    implements PlanMetaLocalService {
    ...
    public PlanMeta addPlanMeta(PlanMeta planMeta) throws SystemException {
        planMeta.setNew(true);

        return planMetaPersistence.update(planMeta, false);
    }
    ...
    public void deletePlanMeta(Long id) throws PortalException, SystemException {
        planMetaPersistence.remove(id);
    }

    public void deletePlanMeta(PlanMeta planMeta) throws SystemException {
        planMetaPersistence.remove(planMeta);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planMetaPersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return planMetaPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List<PlanMeta> getPlanMetas(int start, int end)
        throws SystemException {
        return planMetaPersistence.findAll(start, end);
    }

    public int getPlanMetasCount() throws SystemException {
        return planMetaPersistence.countAll();
    }

    public PlanMeta updatePlanMeta(PlanMeta planMeta) throws SystemException {
        planMeta.setNew(false);

        return planMetaPersistence.update(planMeta, true);
    }

    public PlanMeta updatePlanMeta(PlanMeta planMeta, boolean merge)
        throws SystemException {
        planMeta.setNew(false);

        return planMetaPersistence.update(planMeta, merge);
    }
