...
public abstract class PlanPositionLocalServiceBaseImpl
    implements PlanPositionLocalService {
    ...
    public PlanPosition addPlanPosition(PlanPosition planPosition)
        throws SystemException {
        planPosition.setNew(true);

        return planPositionPersistence.update(planPosition, false);
    }

    public PlanPosition createPlanPosition(PlanPositionPK planPositionPK) {
        return planPositionPersistence.create(planPositionPK);
    }

    public void deletePlanPosition(PlanPositionPK planPositionPK)
        throws PortalException, SystemException {
        planPositionPersistence.remove(planPositionPK);
    }

    public void deletePlanPosition(PlanPosition planPosition)
        throws SystemException {
        planPositionPersistence.remove(planPosition);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planPositionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PlanPosition getPlanPosition(PlanPositionPK planPositionPK)
        throws PortalException, SystemException {
        return planPositionPersistence.findByPrimaryKey(planPositionPK);
    }

    public List<PlanPosition> getPlanPositions(int start, int end)
        throws SystemException {
        return planPositionPersistence.findAll(start, end);
    }

    public int getPlanPositionsCount() throws SystemException {
        return planPositionPersistence.countAll();
    }

    public PlanPosition updatePlanPosition(PlanPosition planPosition)
        throws SystemException {
        planPosition.setNew(false);

        return planPositionPersistence.update(planPosition, true);
    }
    ...
    public PlanPosition updatePlanPosition(PlanPosition planPosition,
        ...
        return planPositionPersistence.update(planPosition, merge);
    }
