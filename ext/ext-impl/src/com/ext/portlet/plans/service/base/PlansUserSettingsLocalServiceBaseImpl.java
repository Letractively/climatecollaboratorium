...
public abstract class PlansUserSettingsLocalServiceBaseImpl
    ...
    public PlansUserSettings addPlansUserSettings(
        PlansUserSettings plansUserSettings) throws SystemException {
        plansUserSettings.setNew(true);

        return plansUserSettingsPersistence.update(plansUserSettings, false);
    }
    ...
    public void deletePlansUserSettings(Long planUserSettingsId)
        ...
        plansUserSettingsPersistence.remove(planUserSettingsId);
    }

    public void deletePlansUserSettings(PlansUserSettings plansUserSettings)
        throws SystemException {
        plansUserSettingsPersistence.remove(plansUserSettings);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return plansUserSettingsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlansUserSettings> getPlansUserSettingses(int start, int end)
        throws SystemException {
        return plansUserSettingsPersistence.findAll(start, end);
    }

    public int getPlansUserSettingsesCount() throws SystemException {
        return plansUserSettingsPersistence.countAll();
    }

    public PlansUserSettings updatePlansUserSettings(
        PlansUserSettings plansUserSettings) throws SystemException {
        plansUserSettings.setNew(false);

        return plansUserSettingsPersistence.update(plansUserSettings, true);
    }
    ...
    public PlansUserSettings updatePlansUserSettings(
        ...
        return plansUserSettingsPersistence.update(plansUserSettings, merge);
    }
