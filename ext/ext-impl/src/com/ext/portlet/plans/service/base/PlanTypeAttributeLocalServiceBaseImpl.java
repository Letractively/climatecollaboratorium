...
public abstract class PlanTypeAttributeLocalServiceBaseImpl
    ...
    public PlanTypeAttribute addPlanTypeAttribute(
        PlanTypeAttribute planTypeAttribute) throws SystemException {
        planTypeAttribute.setNew(true);

        return planTypeAttributePersistence.update(planTypeAttribute, false);
    }
    ...
    public void deletePlanTypeAttribute(Long planTypeAttributeId)
        ...
        planTypeAttributePersistence.remove(planTypeAttributeId);
    }

    public void deletePlanTypeAttribute(PlanTypeAttribute planTypeAttribute)
        throws SystemException {
        planTypeAttributePersistence.remove(planTypeAttribute);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planTypeAttributePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanTypeAttribute> getPlanTypeAttributes(int start, int end)
        throws SystemException {
        return planTypeAttributePersistence.findAll(start, end);
    }

    public int getPlanTypeAttributesCount() throws SystemException {
        return planTypeAttributePersistence.countAll();
    }

    public PlanTypeAttribute updatePlanTypeAttribute(
        PlanTypeAttribute planTypeAttribute) throws SystemException {
        planTypeAttribute.setNew(false);

        return planTypeAttributePersistence.update(planTypeAttribute, true);
    }
    ...
    public PlanTypeAttribute updatePlanTypeAttribute(
        ...
        return planTypeAttributePersistence.update(planTypeAttribute, merge);
    }
