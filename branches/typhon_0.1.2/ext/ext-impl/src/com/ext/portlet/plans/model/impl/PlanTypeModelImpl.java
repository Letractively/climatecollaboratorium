...
public class PlanTypeModelImpl extends BaseModelImpl<PlanType> {
    ...
    public PlanType toEscapedModel() {
        if (isEscapedModel()) {
            ...
            model.setDefaultScenarioId(getDefaultScenarioId());
