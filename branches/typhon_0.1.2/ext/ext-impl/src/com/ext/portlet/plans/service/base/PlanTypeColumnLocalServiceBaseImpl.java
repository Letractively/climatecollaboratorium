...
public abstract class PlanTypeColumnLocalServiceBaseImpl
    ...
    public PlanTypeColumn addPlanTypeColumn(PlanTypeColumn planTypeColumn)
        throws SystemException {
        planTypeColumn.setNew(true);

        return planTypeColumnPersistence.update(planTypeColumn, false);
    }
    ...
    public void deletePlanTypeColumn(Long planTypeColumnId)
        ...
        planTypeColumnPersistence.remove(planTypeColumnId);
    }

    public void deletePlanTypeColumn(PlanTypeColumn planTypeColumn)
        throws SystemException {
        planTypeColumnPersistence.remove(planTypeColumn);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planTypeColumnPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanTypeColumn> getPlanTypeColumns(int start, int end)
        throws SystemException {
        return planTypeColumnPersistence.findAll(start, end);
    }

    public int getPlanTypeColumnsCount() throws SystemException {
        return planTypeColumnPersistence.countAll();
    }

    public PlanTypeColumn updatePlanTypeColumn(PlanTypeColumn planTypeColumn)
        throws SystemException {
        planTypeColumn.setNew(false);

        return planTypeColumnPersistence.update(planTypeColumn, true);
    }
    ...
    public PlanTypeColumn updatePlanTypeColumn(PlanTypeColumn planTypeColumn,
        ...
        return planTypeColumnPersistence.update(planTypeColumn, merge);
    }
