...
public abstract class DebateLocalServiceBaseImpl implements DebateLocalService {
    ...
    public Debate addDebate(Debate debate) throws SystemException {
        debate.setNew(true);

        return debatePersistence.update(debate, false);
    }

    public Debate createDebate(Long debatePK) {
        return debatePersistence.create(debatePK);
    }

    public void deleteDebate(Long debatePK)
        throws PortalException, SystemException {
        debatePersistence.remove(debatePK);
    }

    public void deleteDebate(Debate debate) throws SystemException {
        debatePersistence.remove(debate);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return debatePersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return debatePersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }

    public Debate getDebate(Long debatePK)
        throws PortalException, SystemException {
        return debatePersistence.findByPrimaryKey(debatePK);
    }

    public List<Debate> getDebates(int start, int end)
        throws SystemException {
        return debatePersistence.findAll(start, end);
    }

    public int getDebatesCount() throws SystemException {
        return debatePersistence.countAll();
    }

    public Debate updateDebate(Debate debate) throws SystemException {
        debate.setNew(false);

        return debatePersistence.update(debate, true);
    }

    public Debate updateDebate(Debate debate, boolean merge)
        throws SystemException {
        debate.setNew(false);

        return debatePersistence.update(debate, merge);
    }
