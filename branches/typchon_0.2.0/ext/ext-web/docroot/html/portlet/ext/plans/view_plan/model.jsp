...
<script type="text/javascript">
    ...
    function portletModelImpactsInnerPortlet() {
        ...
        jQuery(frameContent).find("#modelName").click(function() {document.location = "/web/guest/models/#modelId=<%= plan.getPlanType().getModelId() %>"});
    }
    ...
    */ 
    ...
    Liferay.Widget({ url: "/widget/web/guest/models/-/models_WAR_modelsportlet_INSTANCE_c0EK?modelId=<%= plan.getPlanType().getModelId() %><%= plan.getScenarioId() != null ? "&scenarioId=" + plan.getScenarioId() : "" %>&viewType=embedded&page=model" ,  id: "portlet-model-impacts", scrolling: "no", FRAMEBORDER: 0});
