...
public abstract class PlanRelatedLocalServiceBaseImpl
    implements PlanRelatedLocalService {
    ...
    public PlanRelated addPlanRelated(PlanRelated planRelated)
        throws SystemException {
        planRelated.setNew(true);

        return planRelatedPersistence.update(planRelated, false);
    }

    public PlanRelated createPlanRelated(PlanRelatedPK planRelatedPK) {
        return planRelatedPersistence.create(planRelatedPK);
    }

    public void deletePlanRelated(PlanRelatedPK planRelatedPK)
        throws PortalException, SystemException {
        planRelatedPersistence.remove(planRelatedPK);
    }

    public void deletePlanRelated(PlanRelated planRelated)
        throws SystemException {
        planRelatedPersistence.remove(planRelated);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planRelatedPersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return planRelatedPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }

    public PlanRelated getPlanRelated(PlanRelatedPK planRelatedPK)
        throws PortalException, SystemException {
        return planRelatedPersistence.findByPrimaryKey(planRelatedPK);
    }

    public List<PlanRelated> getPlanRelateds(int start, int end)
        throws SystemException {
        return planRelatedPersistence.findAll(start, end);
    }

    public int getPlanRelatedsCount() throws SystemException {
        return planRelatedPersistence.countAll();
    }

    public PlanRelated updatePlanRelated(PlanRelated planRelated)
        throws SystemException {
        planRelated.setNew(false);

        return planRelatedPersistence.update(planRelated, true);
    }

    public PlanRelated updatePlanRelated(PlanRelated planRelated, boolean merge)
        throws SystemException {
        planRelated.setNew(false);

        return planRelatedPersistence.update(planRelated, merge);
    }
