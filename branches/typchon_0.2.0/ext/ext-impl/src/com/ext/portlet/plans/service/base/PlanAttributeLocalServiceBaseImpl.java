...
public abstract class PlanAttributeLocalServiceBaseImpl
    ...
    public PlanAttribute addPlanAttribute(PlanAttribute planAttribute)
        throws SystemException {
        planAttribute.setNew(true);

        return planAttributePersistence.update(planAttribute, false);
    }
    ...
    public void deletePlanAttribute(Long attributeId)
        ...
        planAttributePersistence.remove(attributeId);
    }

    public void deletePlanAttribute(PlanAttribute planAttribute)
        throws SystemException {
        planAttributePersistence.remove(planAttribute);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planAttributePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanAttribute> getPlanAttributes(int start, int end)
        throws SystemException {
        return planAttributePersistence.findAll(start, end);
    }

    public int getPlanAttributesCount() throws SystemException {
        return planAttributePersistence.countAll();
    }

    public PlanAttribute updatePlanAttribute(PlanAttribute planAttribute)
        throws SystemException {
        planAttribute.setNew(false);

        return planAttributePersistence.update(planAttribute, true);
    }
    ...
    public PlanAttribute updatePlanAttribute(PlanAttribute planAttribute,
        ...
        return planAttributePersistence.update(planAttribute, merge);
    }
