...
public abstract class PlanTemplateLocalServiceBaseImpl
    implements PlanTemplateLocalService {
    ...
    public PlanTemplate addPlanTemplate(PlanTemplate planTemplate)
        throws SystemException {
        planTemplate.setNew(true);

        return planTemplatePersistence.update(planTemplate, false);
    }
    ...
    public void deletePlanTemplate(Long id)
        ...
        planTemplatePersistence.remove(id);
    }

    public void deletePlanTemplate(PlanTemplate planTemplate)
        throws SystemException {
        planTemplatePersistence.remove(planTemplate);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planTemplatePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanTemplate> getPlanTemplates(int start, int end)
        throws SystemException {
        return planTemplatePersistence.findAll(start, end);
    }

    public int getPlanTemplatesCount() throws SystemException {
        return planTemplatePersistence.countAll();
    }

    public PlanTemplate updatePlanTemplate(PlanTemplate planTemplate)
        throws SystemException {
        planTemplate.setNew(false);

        return planTemplatePersistence.update(planTemplate, true);
    }
    ...
    public PlanTemplate updatePlanTemplate(PlanTemplate planTemplate,
        ...
        return planTemplatePersistence.update(planTemplate, merge);
    }
