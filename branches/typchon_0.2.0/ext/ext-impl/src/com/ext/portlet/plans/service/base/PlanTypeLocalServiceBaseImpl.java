...
public abstract class PlanTypeLocalServiceBaseImpl
    implements PlanTypeLocalService {
    ...
    public PlanType addPlanType(PlanType planType) throws SystemException {
        ...
        return planTypePersistence.update(planType, false);
    }
    ...
    public void deletePlanType(Long planTypeId)
        ...
        planTypePersistence.remove(planTypeId);
    }

    public void deletePlanType(PlanType planType) throws SystemException {
        planTypePersistence.remove(planType);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planTypePersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return planTypePersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List<PlanType> getPlanTypes(int start, int end)
        throws SystemException {
        return planTypePersistence.findAll(start, end);
    }

    public int getPlanTypesCount() throws SystemException {
        return planTypePersistence.countAll();
    }

    public PlanType updatePlanType(PlanType planType) throws SystemException {
        planType.setNew(false);

        return planTypePersistence.update(planType, true);
    }

    public PlanType updatePlanType(PlanType planType, boolean merge)
        throws SystemException {
        planType.setNew(false);

        return planTypePersistence.update(planType, merge);
    }
