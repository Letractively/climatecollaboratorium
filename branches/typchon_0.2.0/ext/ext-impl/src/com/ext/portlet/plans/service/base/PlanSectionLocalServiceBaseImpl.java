...
public abstract class PlanSectionLocalServiceBaseImpl
    implements PlanSectionLocalService {
    ...
    public PlanSection addPlanSection(PlanSection planSection)
    ...
    public void deletePlanSection(PlanSection planSection)
        throws SystemException {
        planSectionPersistence.remove(planSection);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planSectionPersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return planSectionPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public List<PlanSection> getPlanSections(int start, int end)
        throws SystemException {
        return planSectionPersistence.findAll(start, end);
    }

    public int getPlanSectionsCount() throws SystemException {
        return planSectionPersistence.countAll();
    }

    public PlanSection updatePlanSection(PlanSection planSection)
        throws SystemException {
        planSection.setNew(false);

        return planSectionPersistence.update(planSection, true);
    }

    public PlanSection updatePlanSection(PlanSection planSection, boolean merge)
        throws SystemException {
        planSection.setNew(false);

        return planSectionPersistence.update(planSection, merge);
    }
