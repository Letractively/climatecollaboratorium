...
public abstract class PlanSectionPlanMapLocalServiceBaseImpl
    ...
    public PlanSectionPlanMap addPlanSectionPlanMap(
        PlanSectionPlanMap planSectionPlanMap) throws SystemException {
        planSectionPlanMap.setNew(true);

        return planSectionPlanMapPersistence.update(planSectionPlanMap, false);
    }

    public PlanSectionPlanMap createPlanSectionPlanMap(
        PlanSectionPlanMapPK planSectionPlanMapPK) {
        return planSectionPlanMapPersistence.create(planSectionPlanMapPK);
    }

    public void deletePlanSectionPlanMap(
        PlanSectionPlanMapPK planSectionPlanMapPK)
        throws PortalException, SystemException {
        planSectionPlanMapPersistence.remove(planSectionPlanMapPK);
    }

    public void deletePlanSectionPlanMap(PlanSectionPlanMap planSectionPlanMap)
        throws SystemException {
        planSectionPlanMapPersistence.remove(planSectionPlanMap);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planSectionPlanMapPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PlanSectionPlanMap getPlanSectionPlanMap(
        PlanSectionPlanMapPK planSectionPlanMapPK)
        throws PortalException, SystemException {
        return planSectionPlanMapPersistence.findByPrimaryKey(planSectionPlanMapPK);
    }

    public List<PlanSectionPlanMap> getPlanSectionPlanMaps(int start, int end)
        throws SystemException {
        return planSectionPlanMapPersistence.findAll(start, end);
    }

    public int getPlanSectionPlanMapsCount() throws SystemException {
        return planSectionPlanMapPersistence.countAll();
    }

    public PlanSectionPlanMap updatePlanSectionPlanMap(
        PlanSectionPlanMap planSectionPlanMap) throws SystemException {
        planSectionPlanMap.setNew(false);

        return planSectionPlanMapPersistence.update(planSectionPlanMap, true);
    }
    ...
    public PlanSectionPlanMap updatePlanSectionPlanMap(
        ...
        return planSectionPlanMapPersistence.update(planSectionPlanMap, merge);
    }
