...
public class DebatesSuggestBean {
    ...
    public void addSuggestion(ActionEvent event) throws PortalException, SystemException, AddressException, MailEngineException {
        ...
        users.add(UserLocalServiceUtil.getUserByScreenName(Helper.getThemeDisplay().getCompanyId(), "jintrone"));
        users.add(UserLocalServiceUtil.getUserByScreenName(Helper.getThemeDisplay().getCompanyId(), "laubacher"));
        //debatesPreferences.getSuggestionRecipients();
