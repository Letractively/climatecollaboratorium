...
public abstract class ModelOutputItemModifierLocalServiceBaseImpl
    implements ModelOutputItemModifierLocalService {
    ...
    public ModelOutputItemModifier addModelOutputItemModifier(
        ModelOutputItemModifier modelOutputItemModifier)
        throws SystemException {
        modelOutputItemModifier.setNew(true);

        return modelOutputItemModifierPersistence.update(modelOutputItemModifier,
            false);
    }

    public ModelOutputItemModifier createModelOutputItemModifier(
        Long modelOutputItemModifierPK) {
        return modelOutputItemModifierPersistence.create(modelOutputItemModifierPK);
    }

    public void deleteModelOutputItemModifier(Long modelOutputItemModifierPK)
        throws PortalException, SystemException {
        modelOutputItemModifierPersistence.remove(modelOutputItemModifierPK);
    }

    public void deleteModelOutputItemModifier(
        ModelOutputItemModifier modelOutputItemModifier)
        throws SystemException {
        modelOutputItemModifierPersistence.remove(modelOutputItemModifier);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return modelOutputItemModifierPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public ModelOutputItemModifier getModelOutputItemModifier(
        Long modelOutputItemModifierPK) throws PortalException, SystemException {
        return modelOutputItemModifierPersistence.findByPrimaryKey(modelOutputItemModifierPK);
    }

    public List<ModelOutputItemModifier> getModelOutputItemModifiers(
        int start, int end) throws SystemException {
        return modelOutputItemModifierPersistence.findAll(start, end);
    }

    public int getModelOutputItemModifiersCount() throws SystemException {
        return modelOutputItemModifierPersistence.countAll();
    }

    public ModelOutputItemModifier updateModelOutputItemModifier(
        ModelOutputItemModifier modelOutputItemModifier)
        throws SystemException {
