...
public abstract class DebateMigrationDebateLocalServiceBaseImpl
    implements DebateMigrationDebateLocalService {
    ...
    public DebateMigrationDebate addDebateMigrationDebate(
        DebateMigrationDebate debateMigrationDebate) throws SystemException {
        debateMigrationDebate.setNew(true);

        return debateMigrationDebatePersistence.update(debateMigrationDebate,
            false);
    }

    public DebateMigrationDebate createDebateMigrationDebate(
        Long debateMigrationDebatePK) {
        return debateMigrationDebatePersistence.create(debateMigrationDebatePK);
    }

    public void deleteDebateMigrationDebate(Long debateMigrationDebatePK)
        throws PortalException, SystemException {
        debateMigrationDebatePersistence.remove(debateMigrationDebatePK);
    }

    public void deleteDebateMigrationDebate(
        DebateMigrationDebate debateMigrationDebate) throws SystemException {
        debateMigrationDebatePersistence.remove(debateMigrationDebate);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return debateMigrationDebatePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public DebateMigrationDebate getDebateMigrationDebate(
        Long debateMigrationDebatePK) throws PortalException, SystemException {
        return debateMigrationDebatePersistence.findByPrimaryKey(debateMigrationDebatePK);
    }

    public List<DebateMigrationDebate> getDebateMigrationDebates(int start,
        int end) throws SystemException {
        return debateMigrationDebatePersistence.findAll(start, end);
    }

    public int getDebateMigrationDebatesCount() throws SystemException {
        return debateMigrationDebatePersistence.countAll();
    }

    public DebateMigrationDebate updateDebateMigrationDebate(
        DebateMigrationDebate debateMigrationDebate) throws SystemException {
