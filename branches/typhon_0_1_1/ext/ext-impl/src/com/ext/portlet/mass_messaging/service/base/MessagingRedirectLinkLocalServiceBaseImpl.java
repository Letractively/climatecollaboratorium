...
public abstract class MessagingRedirectLinkLocalServiceBaseImpl
    implements MessagingRedirectLinkLocalService {
    ...
    public MessagingRedirectLink addMessagingRedirectLink(
        MessagingRedirectLink messagingRedirectLink) throws SystemException {
        messagingRedirectLink.setNew(true);

        return messagingRedirectLinkPersistence.update(messagingRedirectLink,
            false);
    }

    public MessagingRedirectLink createMessagingRedirectLink(Long redirectId) {
        return messagingRedirectLinkPersistence.create(redirectId);
    }

    public void deleteMessagingRedirectLink(Long redirectId)
        throws PortalException, SystemException {
        messagingRedirectLinkPersistence.remove(redirectId);
    }

    public void deleteMessagingRedirectLink(
        MessagingRedirectLink messagingRedirectLink) throws SystemException {
        messagingRedirectLinkPersistence.remove(messagingRedirectLink);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return messagingRedirectLinkPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public MessagingRedirectLink getMessagingRedirectLink(Long redirectId)
        throws PortalException, SystemException {
        return messagingRedirectLinkPersistence.findByPrimaryKey(redirectId);
    }

    public List<MessagingRedirectLink> getMessagingRedirectLinks(int start,
        int end) throws SystemException {
        return messagingRedirectLinkPersistence.findAll(start, end);
    }

    public int getMessagingRedirectLinksCount() throws SystemException {
        return messagingRedirectLinkPersistence.countAll();
    }

    public MessagingRedirectLink updateMessagingRedirectLink(
        MessagingRedirectLink messagingRedirectLink) throws SystemException {
