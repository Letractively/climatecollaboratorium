...
public abstract class PlanVoteLocalServiceBaseImpl
    implements PlanVoteLocalService {
    ...
    public PlanVote addPlanVote(PlanVote planVote) throws SystemException {
    ...
    public void deletePlanVote(PlanVote planVote) throws SystemException {
        planVotePersistence.remove(planVote);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planVotePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanVote> getPlanVotes(int start, int end)
        throws SystemException {
        return planVotePersistence.findAll(start, end);
    }

    public int getPlanVotesCount() throws SystemException {
        return planVotePersistence.countAll();
    }

    public PlanVote updatePlanVote(PlanVote planVote) throws SystemException {
        planVote.setNew(false);

        return planVotePersistence.update(planVote, true);
    }

    public PlanVote updatePlanVote(PlanVote planVote, boolean merge)
        throws SystemException {
        planVote.setNew(false);

        return planVotePersistence.update(planVote, merge);
    }
