...
<%@page import="com.ext.portlet.mass_messaging.model.MessagingMessageConversion"%>
<%@page import="com.ext.portlet.mass_messaging.service.MessagingMessageConversionTypeLocalServiceUtil"%>
<%@page import="com.ext.portlet.mass_messaging.service.MessagingMessageConversionTypeLocalService"%>
<%@page import="com.ext.portlet.mass_messaging.service.MessagingMessageConversionLocalServiceUtil"%>
<%@page import="com.ext.portlet.mass_messaging.MessagingUtils"%>


<%@page import="com.ext.portlet.mass_messaging.MessagingConversionTypes"%>
<%@page import="java.text.NumberFormat"%><h2>Message details</h2>
