...
jQuery(document).ready(function() {
	...
	//var contentDocument = jQuery(".discussion");
	var contentDocument = jQuery(document);

	// add search box like in the prototype
	
	searchBoxContainer = contentDocument.find("#_debates_keywords2").parent();
	searchBoxContainer.html('<div class="searchInputBox"><input class="text" type="text"/>' + 
			'<a class="searchBtn" href="javascript:;" onClick="document._debates_fm2.submit()" ><span class="hidden">Search</span></a></div>' + 
			'<a class="newThread" href="javascript:;" onClick="_debates_addMessage();"><span class="hidden">Post New Thread</span></a><div class="clear"/>');
...
function _debates_showDialog(dialogId, options) {
...
function _debates_closeDialog(dialogId) {
