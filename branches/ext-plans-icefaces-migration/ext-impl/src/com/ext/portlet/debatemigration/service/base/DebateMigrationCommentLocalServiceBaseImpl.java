...
public abstract class DebateMigrationCommentLocalServiceBaseImpl
    implements DebateMigrationCommentLocalService {
    ...
    public DebateMigrationComment addDebateMigrationComment(
        DebateMigrationComment debateMigrationComment)
        throws SystemException {
        debateMigrationComment.setNew(true);

        return debateMigrationCommentPersistence.update(debateMigrationComment,
            false);
    }

    public DebateMigrationComment createDebateMigrationComment(
        Long debateMigrationCommentPK) {
        return debateMigrationCommentPersistence.create(debateMigrationCommentPK);
    }

    public void deleteDebateMigrationComment(Long debateMigrationCommentPK)
        throws PortalException, SystemException {
        debateMigrationCommentPersistence.remove(debateMigrationCommentPK);
    }

    public void deleteDebateMigrationComment(
        DebateMigrationComment debateMigrationComment)
        throws SystemException {
        debateMigrationCommentPersistence.remove(debateMigrationComment);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return debateMigrationCommentPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public DebateMigrationComment getDebateMigrationComment(
        Long debateMigrationCommentPK) throws PortalException, SystemException {
        return debateMigrationCommentPersistence.findByPrimaryKey(debateMigrationCommentPK);
    }

    public List<DebateMigrationComment> getDebateMigrationComments(int start,
        int end) throws SystemException {
        return debateMigrationCommentPersistence.findAll(start, end);
    }

    public int getDebateMigrationCommentsCount() throws SystemException {
        return debateMigrationCommentPersistence.countAll();
    }

    public DebateMigrationComment updateDebateMigrationComment(
        DebateMigrationComment debateMigrationComment)
        throws SystemException {
