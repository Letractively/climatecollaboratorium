...
public abstract class DebateItemVoteLocalServiceBaseImpl
    implements DebateItemVoteLocalService {
    ...
    public DebateItemVote addDebateItemVote(DebateItemVote debateItemVote)
        throws SystemException {
        debateItemVote.setNew(true);

        return debateItemVotePersistence.update(debateItemVote, false);
    }

    public DebateItemVote createDebateItemVote(Long debateItemVoteId) {
        return debateItemVotePersistence.create(debateItemVoteId);
    }

    public void deleteDebateItemVote(Long debateItemVoteId)
        throws PortalException, SystemException {
        debateItemVotePersistence.remove(debateItemVoteId);
    }

    public void deleteDebateItemVote(DebateItemVote debateItemVote)
        throws SystemException {
        debateItemVotePersistence.remove(debateItemVote);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return debateItemVotePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public DebateItemVote getDebateItemVote(Long debateItemVoteId)
        throws PortalException, SystemException {
        return debateItemVotePersistence.findByPrimaryKey(debateItemVoteId);
    }

    public List<DebateItemVote> getDebateItemVotes(int start, int end)
        throws SystemException {
        return debateItemVotePersistence.findAll(start, end);
    }

    public int getDebateItemVotesCount() throws SystemException {
        return debateItemVotePersistence.countAll();
    }

    public DebateItemVote updateDebateItemVote(DebateItemVote debateItemVote)
        throws SystemException {
        debateItemVote.setNew(false);

        return debateItemVotePersistence.update(debateItemVote, true);
    }
    ...
    public DebateItemVote updateDebateItemVote(DebateItemVote debateItemVote,
        ...
        return debateItemVotePersistence.update(debateItemVote, merge);
    }
