...
public abstract class PlanAttributeFilterLocalServiceBaseImpl
    ...
    public PlanAttributeFilter addPlanAttributeFilter(
        PlanAttributeFilter planAttributeFilter) throws SystemException {
        planAttributeFilter.setNew(true);

        return planAttributeFilterPersistence.update(planAttributeFilter, false);
    }
    ...
    public void deletePlanAttributeFilter(Long planAttributeFilterId)
        ...
        planAttributeFilterPersistence.remove(planAttributeFilterId);
    }

    public void deletePlanAttributeFilter(
        PlanAttributeFilter planAttributeFilter) throws SystemException {
        planAttributeFilterPersistence.remove(planAttributeFilter);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planAttributeFilterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List<PlanAttributeFilter> getPlanAttributeFilters(int start, int end)
        throws SystemException {
        return planAttributeFilterPersistence.findAll(start, end);
    }

    public int getPlanAttributeFiltersCount() throws SystemException {
        return planAttributeFilterPersistence.countAll();
    }

    public PlanAttributeFilter updatePlanAttributeFilter(
        PlanAttributeFilter planAttributeFilter) throws SystemException {
        planAttributeFilter.setNew(false);

        return planAttributeFilterPersistence.update(planAttributeFilter, true);
    }
    ...
    public PlanAttributeFilter updatePlanAttributeFilter(
        ...
        return planAttributeFilterPersistence.update(planAttributeFilter, merge);
    }
