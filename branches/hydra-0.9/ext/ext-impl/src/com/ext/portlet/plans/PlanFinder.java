...
/**
 * Class responsible for retrieval of plans/positions etc. with or without applied
 * filtering. It also provides methods for retrieval of user vote position in
 * current data set.
 *
 * @author janusz.p
 *
 * @version 1.0
 */
public class PlanFinder extends BasePersistenceImpl {
	
	
	private static Log _log = LogFactoryUtil.getLog(PlanFinder.class);
    /**
     ...
     * plans.
     */
    public static final String GET_PLANS = PlanFinder.class.getName() + ".getPlans2";

    /**
     * Name of custom SQL statement that is responsible for counting filtered
     * plans.
     */
    public static final String COUNT_FILTERED_PLANS = PlanFinder.class.getName() + ".countFilteredPlans3";

    /**
     * Name of custom SQL statement that is responsible for counting filtered
     * plans.
     */
    public static final String GET_FILTERED_PLANS = PlanFinder.class.getName() + ".getFilteredPlans4";

    /**
     * Name of custom SQL statement that is responsible for retrieval of user vote position.
     */
    public static final String GET_USER_VOTE_POSITION = PlanFinder.class.getName() + ".getUserVotePosition2";

    /**
     * Name of custom SQL statement that is responsible for retrieval of user vote position.
     */
    public static final String GET_FILTERED_USER_VOTE_POSITION = PlanFinder.class.getName() +
        ".getFilteredUserVotePosition3";

    /**
     * Name of custom SQL statement that is responsible for retrieval of user vote position.
     */
    public static final String GET_PLANS_POSITIONS = PlanFinder.class.getName() + ".getPlansPositions";
     ...
     */
    public static final String COLUMN_PREFIX = "Plan.";
     ...
     * Name column name.
     */
    public static final String COLUMN_NAME = "Plan.name";
     ...
     */
    public static final String COLUMN_CREATE_DATE = "Plan.createDate";

    /**
     * Publish date column name.
     */
    public static final String COLUMN_PUBLISH_DATE = "Plan.publishDate";

    /**
     * Votes column name.
     */
    public static final String COLUMN_VOTES = "Plan.votes";

    /**
     * Plan Id column name.
     */
    public static final String COLUMN_ID = "Plan.planId";
...
//        return 0;
    ...
    private String addAttributes(String sql, PlansUserSettings planUserSettings) throws NoSuchPlanAttributeFilterException, SystemException {
    	...
    	for (PlanConstants.Attribute att:PlanConstants.Attribute.values()) {
    		...
    		attValueString.append((att.isFiltered()&&planUserSettings!=null?"INNER":"LEFT")+" JOIN PlanAttribute as "+atttable+" ON Plan.planId="+atttable+".planId ");
