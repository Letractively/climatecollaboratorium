...
public abstract class DebateMigrationItemLocalServiceBaseImpl
    implements DebateMigrationItemLocalService {
    ...
    public DebateMigrationItem addDebateMigrationItem(
        DebateMigrationItem debateMigrationItem) throws SystemException {
        debateMigrationItem.setNew(true);

        return debateMigrationItemPersistence.update(debateMigrationItem, false);
    }

    public DebateMigrationItem createDebateMigrationItem(
        Long debateMigrationItemPK) {
        return debateMigrationItemPersistence.create(debateMigrationItemPK);
    }

    public void deleteDebateMigrationItem(Long debateMigrationItemPK)
        throws PortalException, SystemException {
        debateMigrationItemPersistence.remove(debateMigrationItemPK);
    }

    public void deleteDebateMigrationItem(
        DebateMigrationItem debateMigrationItem) throws SystemException {
        debateMigrationItemPersistence.remove(debateMigrationItem);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return debateMigrationItemPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public DebateMigrationItem getDebateMigrationItem(
        Long debateMigrationItemPK) throws PortalException, SystemException {
        return debateMigrationItemPersistence.findByPrimaryKey(debateMigrationItemPK);
    }

    public List<DebateMigrationItem> getDebateMigrationItems(int start, int end)
        throws SystemException {
        return debateMigrationItemPersistence.findAll(start, end);
    }

    public int getDebateMigrationItemsCount() throws SystemException {
        return debateMigrationItemPersistence.countAll();
    }

    public DebateMigrationItem updateDebateMigrationItem(
        DebateMigrationItem debateMigrationItem) throws SystemException {
        debateMigrationItem.setNew(false);

        return debateMigrationItemPersistence.update(debateMigrationItem, true);
    }

    public DebateMigrationItem updateDebateMigrationItem(
        DebateMigrationItem debateMigrationItem, boolean merge)
        throws SystemException {
        debateMigrationItem.setNew(false);

        return debateMigrationItemPersistence.update(debateMigrationItem, merge);
    }
