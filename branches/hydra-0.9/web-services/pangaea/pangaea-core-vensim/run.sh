...
${JAVA_HOME}/bin/java ${JAVA_OPTS} -cp lib/log4j-1.2.15.jar:lib/commons-logging-1.1.1.jar:lib/Vensim.jar:build/classes org.climatecollaboratorium.pangaea.vensim.PangaeaConnection
