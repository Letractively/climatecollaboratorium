		...
		for(var itm in st) {
			switch(itm) {
				...
				default:
					...
					if (itm == "width" && st[itm].substring(0,1) == "-") {
						elmStyle[itm] = st[itm].substring(1);
					}
					else {
						elmStyle[itm] = st[itm];
					}
...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '/debates-portlet/img/nicEditorIcons.gif',
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		if(isTextarea || this.options.hasPanel) {
			...
			this.editorContain.setAttribute('class', 'nicEditEditorContainer');
